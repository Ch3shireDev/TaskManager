...
namespace TaskManagerLibrary
{
    public class TimeOfDay
    {
        ...
        //private double TotalDays => TotalSeconds / (24d * SECONDS_PER_HOUR);
        //private double TotalHours => TotalSeconds / (1d * SECONDS_PER_HOUR);
        //private double TotalMinutes => TotalSeconds / 60d;
        ...
        public static TimeOfDay Midnight => new TimeOfDay(0, 0);
        public static TimeOfDay Noon => new TimeOfDay(12, 0);
        public static TimeOfDay Now => new TimeOfDay(DateTime.Now);
        ...
        public static TimeOfDay Parse(string s)
        {
            ...
            var hour = Convert.ToInt32(fields[0]);
            var min = Convert.ToInt32(fields[1]);
            var sec = fields.Length > 2 ? Convert.ToInt32(fields[2]) : 0;
